...
export default ({ data }: AboutPageProps) => (
    <div>
        ...
        <p className={styles.aboutBody}>
            I'm a software developer based in Boston, Massachusetts. My primary focus is iOS development,
            though I have experience developing in Android and WinRT/UWP as well. I have been developing
            apps since 2010 and have been working in apps professionally since 2015. My work experience
            can be found on <a href={data.site.meta.linkedin} className={styles.aboutLink}>LinkedIn</a>.
            My open source contributions can be found on
            &nbsp;<a href={data.site.meta.github} className={styles.aboutLink}>GitHub</a> and
            on <a href={data.site.meta.npm} className={styles.aboutLink}>NPM</a>. I'm currently an
            iOS developer at <a href="https://www.wayfair.com/" className={styles.aboutLink}>Wayfair</a>. 
            Previously, I've worked extensively on React Native apps at
            &nbsp;<a href="https://www.sapientrazorfish.com/" className={styles.aboutLink}>SapientRazorfish</a>&nbsp;
            and as a QA engineer at <a href="https://www.xamarin.com/" className={styles.aboutLink}>Xamarin</a>.
        </p>
