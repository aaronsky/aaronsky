...
export default ({ data }: AboutPageProps) => (
    <div>
        ...
        <p className={styles.aboutBody}>
            I'm a software developer based in Boston, Massachusetts. My primary
            focus is iOS development, though I have experience developing in
            Android and WinRT/UWP as well. I have been developing apps since
            2010 and have been working in apps professionally since 2015. My
            work experience can be found on{' '}
        ...
        <p className={styles.aboutBody}>
            ...
            usually find me in Amory Park in the summer and autumn, or trying to
